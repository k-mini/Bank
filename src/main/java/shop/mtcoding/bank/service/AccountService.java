...
public class AccountService {
    ...
    public AccountWithdrawRespDto 계좌출금(AccountWithdrawReqDto accountWithdrawReqDto, Long userId) {
        ...
        Transaction transaction = Transaction.builder()
                ...
                .depositAccount(null)
                .withdrawAcountBalance(withdrawAccountPS.getBalance())
        ...
        Transaction transctionPS = transactionRepository.save(transaction);

        // DTO 응답
        return new AccountWithdrawRespDto(withdrawAccountPS, transctionPS);
    }
    ...
    public AccountTransferRespDto 계좌이체(AccountTransferReqDto accountTransferReqDto, Long userId) {
        ...
        // DTO 응답
        return new AccountTransferRespDto(withdrawAccountPS, transctionPS);
    }
}
