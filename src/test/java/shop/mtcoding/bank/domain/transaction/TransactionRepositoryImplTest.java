...
public class TransactionRepositoryImplTest extends DummyObject {
        ...
        public void findTransactionList_all_test() throws Exception {
                ...
                transactionListPS.forEach((t) -> {
                        ...
                        System.out.println("테스트 : receive : " + t.getReceiver());
                        System.out.println("테스트 : withdrawAccount 잔액 : " + t.getWithdrawAcountBalance());
                        System.out.println("테스트 : depositAccount 잔액 : " + t.getDepositAccountBalance());
                        System.out.println("테스트 : WithdrawAccount 현재 잔액 : " + t.getWithdrawAccount().getBalance());
                        System.out.println("테스트 : depositAccount 현재 잔액 : " + t.getDepositAccount().getBalance());
        ...
        public void DataJpa_test1() {
                ...
                transactionList.forEach((transaction) -> {
                        ...
                        System.out.println("테스트 : getSender " + transaction.getSender());
                        System.out.println("테스트 : getReceiver " + transaction.getReceiver());
        ...
        private void dataSetting() {
                ...
                Transaction transferTransaction4 = transactionRepository
                                .save(newTransferTransaction(cosAccount, loveAccount, accountRepository));
        }

        // teardown이 안먹혀서 직접 적용.
